...
# Video Link
Video link for the project will be found in the document that's been submitted to canvas

# Development Environment

Tools that were used for this project are the following:
...
- TypeScript: The language to write the logic that gets turned into JavaScript
- JavaScript: The actual code that the TypeScript code is turned into so that the program can run

# Useful Websites

- [YouTube video on TypeScript Overview](https://www.youtube.com/watch?v=zQnBQ4tB3ZA)
