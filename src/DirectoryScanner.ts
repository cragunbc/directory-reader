...
class Scanner { // Creates a Scanner class for the project
    ...
    async printDirectoryResults() { // Defines an async function to print the directory results
        console.log("\nDirectories:"); // Prints the word Directories to the terminal
        console.log("--------------------"); // Prints a divider line
    ...
    async printFileResults() { // Defines an async function to print the file results
        console.log("\nFiles:"); // Prints the word Files to the terminal
        console.log("--------------------"); // Prints a divider line
    ...
    async printStats() { // Defines an async function to print out all of the stats that the program discovered
        console.log("\nStatistics:"); // Prints the word Statistics to the terminal
        console.log("--------------------"); // Prints a divider line
        console.log(`Number of Directories: ${this.directoryResults.length}`); // Prints to the terminal the number of directories that were found
        console.log(`Number of Files: ${this.fileResults.length}`); // Prints to the terminal the number of files that were found
    }
}
